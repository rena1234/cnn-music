...
input_predict = args.midi if args.midi else 'bach_846.mid'
train_output_file = open(args.model,'rb') if args.model else open("models/elements_mig_3_bach_846",'rb')
output_file_path = args.output if args.output else 'results/output_mig_3_bach_846.mid'

model = keras.models.load_model("models/model_mig_3_bach_846")
